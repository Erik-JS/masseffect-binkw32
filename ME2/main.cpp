...
bool PatchME2Console()
{
	...
	//again, another shit-in-one-line from Erik JS...
...
void GetAdresses()
{
	...
	if (hOriginalBink)
	{
		...
		// "_BinkDoFramePlane@8" does not exist in ME2's binkw32
		p[27] = GetProcAddress(hOriginalBink,"_BinkGetError@0");
		p[28] = GetProcAddress(hOriginalBink,"_BinkGetFrameBuffersInfo@8");
		p[29] = GetProcAddress(hOriginalBink,"_BinkGetKeyFrame@12");
		p[30] = GetProcAddress(hOriginalBink,"_BinkGetPalette@4");
		p[31] = GetProcAddress(hOriginalBink,"_BinkGetRealtime@12");
		p[32] = GetProcAddress(hOriginalBink,"_BinkGetRects@8");
		p[33] = GetProcAddress(hOriginalBink,"_BinkGetSummary@8");
		p[34] = GetProcAddress(hOriginalBink,"_BinkGetTrackData@8");
		p[35] = GetProcAddress(hOriginalBink,"_BinkGetTrackID@8");
		p[36] = GetProcAddress(hOriginalBink,"_BinkGetTrackMaxSize@8");
		p[37] = GetProcAddress(hOriginalBink,"_BinkGetTrackType@8");
		p[38] = GetProcAddress(hOriginalBink,"_BinkGoto@12");
		p[39] = GetProcAddress(hOriginalBink,"_BinkIsSoftwareCursor@8");
		p[40] = GetProcAddress(hOriginalBink,"_BinkLogoAddress@0");
		p[41] = GetProcAddress(hOriginalBink,"_BinkNextFrame@4");
		p[42] = GetProcAddress(hOriginalBink,"_BinkOpen@8");
		p[43] = GetProcAddress(hOriginalBink,"_BinkOpenDirectSound@4");
		p[44] = GetProcAddress(hOriginalBink,"_BinkOpenMiles@4");
		p[45] = GetProcAddress(hOriginalBink,"_BinkOpenTrack@8");
		p[46] = GetProcAddress(hOriginalBink,"_BinkOpenWaveOut@4");
		p[47] = GetProcAddress(hOriginalBink,"_BinkPause@8");
		p[48] = GetProcAddress(hOriginalBink,"_BinkRegisterFrameBuffers@8");
		p[49] = GetProcAddress(hOriginalBink,"_BinkRequestStopAsyncThread@4");
		p[50] = GetProcAddress(hOriginalBink,"_BinkRestoreCursor@4");
		p[51] = GetProcAddress(hOriginalBink,"_BinkService@4");
		p[52] = GetProcAddress(hOriginalBink,"_BinkSetError@4");
		p[53] = GetProcAddress(hOriginalBink,"_BinkSetFrameRate@8");
		p[54] = GetProcAddress(hOriginalBink,"_BinkSetIO@4");
		p[55] = GetProcAddress(hOriginalBink,"_BinkSetIOSize@4");
		p[56] = GetProcAddress(hOriginalBink,"_BinkSetMemory@8");
		p[57] = GetProcAddress(hOriginalBink,"_BinkSetMixBinVolumes@20");
		p[58] = GetProcAddress(hOriginalBink,"_BinkSetMixBins@16");
		p[59] = GetProcAddress(hOriginalBink,"_BinkSetPan@12");
		p[60] = GetProcAddress(hOriginalBink,"_BinkSetSimulate@4");
		p[61] = GetProcAddress(hOriginalBink,"_BinkSetSoundOnOff@8");
		p[62] = GetProcAddress(hOriginalBink,"_BinkSetSoundSystem@8");
		p[63] = GetProcAddress(hOriginalBink,"_BinkSetSoundTrack@8");
		p[64] = GetProcAddress(hOriginalBink,"_BinkSetVideoOnOff@8");
		p[65] = GetProcAddress(hOriginalBink,"_BinkSetVolume@12");
		p[66] = GetProcAddress(hOriginalBink,"_BinkShouldSkip@4");
		p[67] = GetProcAddress(hOriginalBink,"_BinkStartAsyncThread@8");
		p[68] = GetProcAddress(hOriginalBink,"_BinkWait@4");
		p[69] = GetProcAddress(hOriginalBink,"_BinkWaitStopAsyncThread@4");
		p[70] = GetProcAddress(hOriginalBink,"_RADTimerRead@0");
	}
}
